...
export default function DashboardLayout() {
  ...
  return (
    <div className="d-flex vh-100">
      <aside
        className="bg-emerald-900 text-white d-flex flex-column flex-shrink-0"
        style={{ width: '260px' }}
      >
          ...
          {isAdmin && (
            <>
              <div
                ...
                style={{ color: '#6ee7b7', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.08em', cursor: 'default' }}
              >
                🛡️ Administration
              </div>
        ...
        <div className="p-3 border-top border-emerald-800">
          ...
          <p className="small text-emerald-400 mb-3">
            {tokenPayload?.groups.join(', ') || 'Membre'}
          </p>
          <a
            href="#"
